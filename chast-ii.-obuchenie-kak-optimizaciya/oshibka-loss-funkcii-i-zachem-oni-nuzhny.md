...
Есть важный, но часто неявный факт. Если мы используем MSE, то мы неявно предполагаем, что ошибки распределены нормально. При этом нужно понимать, что минимизация MSE эквивалентна MLE при нормальном шуме, что можно рассматривать как статистическую интерпретацию этого выбора.:
...
Log loss можно интерпретировать как меру расхождения между истинным и предсказанным распределениями.
