...
Вектор $$\mathbf{w}$$ задаёт ориентацию этой плоскости, а $$b$$ – её сдвиг. Предсказание $$\hat{y}$$ – это значение линейной функции, зависящее от того, насколько вектор признаков $$x$$ сонаправлен с вектором весов $$w$$, с учётом смещения.
