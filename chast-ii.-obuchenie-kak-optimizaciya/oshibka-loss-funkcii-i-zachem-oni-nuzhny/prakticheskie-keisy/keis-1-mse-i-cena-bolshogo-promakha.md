...
{% hint style="info" %}
Чтобы самостоятельно протестировать этот код, установите примеры файлов из официального репозитория [GitHub](https://github.com/apphp/ai-for-php-developers-examples) или запустите его с помощью [онлайн-примеров](http://localhost:8088/part-2/errors-and-loss-functions)
{% endhint %}
