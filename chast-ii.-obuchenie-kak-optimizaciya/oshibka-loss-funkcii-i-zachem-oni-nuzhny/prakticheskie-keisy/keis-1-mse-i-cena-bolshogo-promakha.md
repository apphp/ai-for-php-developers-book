...
{% hint style="info" %}
Чтобы самостоятельно протестировать этот код, установите примеры файлов из официального репозитория [GitHub](https://github.com/apphp/ai-for-php-developers-examples) или запустите его с помощью [онлайн-примеров](https://aiwithphp.org/books/ai-for-php-developers/examples/part-2/errors-and-loss-functions)
{% endhint %}
