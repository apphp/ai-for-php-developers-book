...
– это значит, что при всех известных признаках модель почти уверена в этом классе.
...
Представим тест на заболевание. Он не идеален.
...
Смысл этого шага не в "магии", а в том, чтобы привести оценки модели к форме степеней уверенности, с которыми удобно работать дальше – сравнивать, пороговать, интерпретировать.
...
Важно понимать: вероятность сама по себе ничего не решает. Решения принимает бизнес-логика.
