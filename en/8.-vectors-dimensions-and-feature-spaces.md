...
Feature space is the environment where the machine learning algorithm operates. Everything that used to be strings, dates, categories, and JSON becomes pure math – a set of numbers – after [feature engineering](getting-started/5.-glossary.md#feature-engineering).
...
Neural networks are the next level of complexity. Each layer performs an [affine transformation](getting-started/5.-glossary.md#affine-transformation):
