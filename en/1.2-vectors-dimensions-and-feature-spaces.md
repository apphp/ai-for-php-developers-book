...
Not all features are numeric by default. Color, country, device type – these are categories. To place them in feature space, we need to convert them into numbers. The most common approach is [one-hot encoding](getting-started/glossary.md#one-hot-encoding).
...
<div align="left"><figure><img src=".gitbook/assets/1.2-1_points-in-2d-feature-space.png" alt=""><figcaption><p>Figure 1.2-1. Points in 2D feature space</p></figcaption></figure></div>
...
That’s why [cosine similarity](getting-started/glossary.md#cosine-similarity) is commonly used with text embeddings and other high-dimensional data, where direction matters more than magnitude.
...
<div align="left"><figure><img src=".gitbook/assets/1.2-2_angle-between-2-vectors.png" alt=""><figcaption><p>Figure 1.2-2. Angle between two vectors</p></figcaption></figure></div>
...
<figure><img src=".gitbook/assets/1.2-3_knn-in-feature-space.png" alt=""><figcaption><p>Figure 1.2-3. k-NN algorithm in feature space</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/1.2-4_linear-decision-boundary.png" alt=""><figcaption><p>Figure 1.2-4. Linear decision boundary</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/1.2-5_nonlinear-transformation-of-space.png" alt=""><figcaption><p>Figure 1.2-5. Nonlinear transformation of space</p></figcaption></figure>
