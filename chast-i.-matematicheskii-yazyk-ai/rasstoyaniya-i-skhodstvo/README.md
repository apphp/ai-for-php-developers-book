...
Как вы наверняка запомнили из предыдущей главы – евклидово расстояние чувствительно к масштабу и поэтому перед использованием такого расстояния данные часто нормализуют.
...
<div align="left"><figure><img src="../../.gitbook/assets/7.2-2-vectors-and-angle-between-them.png" alt="" width="563"><figcaption><p>Два вектора и угол между ними</p></figcaption></figure></div>

Dot product (скалярное произведение) становится большим, когда одновременно выполняются два условия:

1. Векторы смотрят почти в одну сторону\
   Если угол между ними маленький, их направления совпадают – вклад большой.
2. Векторы длинные\
   Чем больше длины векторов, тем больше итоговое значение, даже если направление то же самое.
...
<div align="left"><figure><img src="../../.gitbook/assets/7.3-dot-product-as-proection-one-vertor-into-another.png" alt="" width="563"><figcaption><p>Dot product как проекция одного вектора на другой</p></figcaption></figure></div>
...
Оно определяется формулой (нетрудно заметить, что она выводится из формулы скалярного произведения векторов):
...
<div align="left"><figure><img src="../../.gitbook/assets/7.4-same-angle-different-vector-lengths.png" alt="" width="563"><figcaption><p>Один и тот же угол, разные длины векторов</p></figcaption></figure></div>
