...
В этой главе мы разберем три ключевых инструмента: евклидово расстояние, скалярное произведение (dot product) и [косинусное сходство](../../vvedenie/glossarii.md#cosine-similarity-kosinusnoe-skhodstvo) (cosine similarity). Они лежат в основе kNN, линейных моделей, рекомендательных систем, поиска по текстам и эмбеддингов.
...
<div align="left"><figure><img src="../../.gitbook/assets/7.3-dot-product-as-proection-one-vertor-into-another.png" alt="" width="563"><figcaption><p>9.3 Dot product как проекция одного вектора на другой</p></figcaption></figure></div>
