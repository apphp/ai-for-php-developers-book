...
Если $$n = 2$$, это расстояние между точками на плоскости. Если $$n = 100$$ или $$768$$, геометрия остается той же самой, просто ее уже нельзя нарисовать напрямую.
...
Важно понимать, что евклидово расстояние чувствительно к масштабу. Если один признак измеряется в тысячах, а другой – в долях, первый будет доминировать. Поэтому перед использованием такого расстояния данные почти всегда нормализуют.
