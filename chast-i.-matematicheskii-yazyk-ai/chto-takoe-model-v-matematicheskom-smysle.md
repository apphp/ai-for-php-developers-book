...
Обратите внимание на важный момент. Ошибка напрямую зависит от `$yPredicted`, а `$ePredicted` зависит от параметров модели. Значит, в конечном итоге ошибка – это функция от параметров модели.
...
Если вы это поняли, то половина страха перед машинным обучением уже исчезла. Дальше начинается инженерия: какие функции брать, какие ошибки использовать и как эффективно подбирать параметры.
