...
Нейронные сети – это следующий шаг усложнения. Каждый слой выполняет [аффинное преобразование](#user-content-fn-2)[^2]:
