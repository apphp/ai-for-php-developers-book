...
[**Введение**](vvedenie/)\
_&#x41C;отивация, реалии и цели книги._
...
_&#x41E;бзор экосистемы PHP для машинного обучения и научных вычислений._
...
_&#x4D;SE, log loss – без формального ада._
...
_&#x413;еометрическая интуиция, метрики расстояний._
...
_&#x41F;ространство слов и признаки._
...
_&#x413;еометрия смысла и_ семантический поис&#x43A;_._
...
_&#x41F;очему слово "ключ" имеет разные векторы. Self-attention без формул._
...
_&#x41E;граничения контекста, подсчет токенов, разбиение документов и overlap._
...
_&#x53;equence labeling, BIO-разметка._
...
_&#x49;nference вместо обучения._ TransformersPHP _как инженерный инструмент._
...
_&#x41F;оиск → контекст → генерация. Как LLM отвечает на основе документов._
...
6.1 🟨 [**Перцептрон и полносвязная сеть**](../chast-vi.-neiroseti-i-rabota-s-dannymi/6.1-perceptron-i-polnosvyaznaya-set/)\
_&#x41B;инейные комбинации и нелинейности._
...
&#x20;  6.2.2 🟨 NIST: как нейросеть учится - backpropagation на практике

6.3 🟨 Свёрточные нейронные сети (CNN)\
_&#x424;ильтры, локальные признаки и почему картинки “понимаются” как матрицы._

6.4 🟨 Автокодировщики\
_&#x421;жатие данных, латентное пространство и восстановление входа._

6.5 🟨 Рекуррентные нейросети (RNN)\
_&#x41C;одели, которые учитывают контекст во времени._

6.6 🟨 Attention как взвешенное суммирование\
_&#x424;ормулы Q/K/V + упрощённая реализация._

&#x20;  6.6.1 🟨 Практические кейсы

### Часть VII. LLM и современный AI

7.1 🟨 Почему LLM – это модели next-token prediction\
_&#x412;ероятности, softmax, контекст._

&#x20;  7.1.1 🟨 Практика: строим next-token модель на PHP

&#x20;  7.1.2 🟨 Практические кейсы

7.2 🟨 Почему LLM ведут себя "разумно": RLHF и обучение поведения\
_&#x41E;т предсказания токенов к полезным ответам._

&#x20;  7.2.1 🟨 Разбираем RLHF на практике

7.3 🟨 Где LLM ошибаются математически\
_&#x413;аллюцинации, распределения, bias._

&#x20; 7.3.1 🟨 Практические кейсы

### Часть VIII. Агентные системы и оркестрация

8.1 🟨 Агентные системы и multi-step reasoning в PHP\
_&#x4C;LM как управляемая система: планирование, инструменты и контроль._

&#x20;  8.1.1 🟨 Практические кейсы

### Часть IX. Продакшен и здравый смысл

9.1 🟨 Как использовать AI в PHP-проектах\
_&#x410;рхитектуры, интеграции, orchestration._

9.2 🟨 Когда AI не нужен и почему это важно\
_&#x41F;онятные инженерные границы._

&#x20;  9.1.1 🟨 Практические кейсы

### Заключение

[**Куда двигаться дальше**](../zaklyuchenie/kuda-dvigatsya-dalshe.md)\
_&#x427;то углублять: математику, системы или практику._
...
Если вам полезен этот материал, вы можете поддержать развитие книги. \
Это помогает продолжать работу и ускоряет выход новых глав.
