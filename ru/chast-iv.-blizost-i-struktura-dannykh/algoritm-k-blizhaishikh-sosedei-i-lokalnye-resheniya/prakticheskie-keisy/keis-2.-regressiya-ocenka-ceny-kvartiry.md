...
* как геометрия пространства признаков напрямую влияет на цену
...
Это делает модель нелинейной. В разных областях пространства признаков поведение может быть разным, потому что решение всегда принимается локально.
...
Хотя алгоритм выглядит простым, важно понимать его ограничения:
...
* не требует обучения в привычном смысле
