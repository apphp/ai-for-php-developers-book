---
description: Применяем kNN для предсказания числового значения.
---
...
* почему kNN можно интерпретировать как простейший [нелинейный регрессор](../../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#nelineinyi-regressor)
...
В этом кейсе kNN используется как [локальный регрессор](../../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#lokalnyi-regressor): цена новой квартиры определяется на основе цен ближайших по характеристикам объектов.
...
Таким образом, kNN реализует [кусочно‑локальную аппроксимацию](../../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#kusochno-lokalnaya-approksimaciya) функции.
