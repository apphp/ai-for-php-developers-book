...
* почему k-NN можно интерпретировать как простейший [нелинейный регрессор](../../../vvedenie/5.-glossarii.md#nelineinyi-regressor)
...
В этом кейсе k-NN используется как [локальный регрессор](../../../vvedenie/5.-glossarii.md#lokalnyi-regressor): цена новой квартиры определяется на основе цен ближайших по характеристикам объектов.
...
Таким образом, k-NN реализует [кусочно‑локальную аппроксимацию](../../../vvedenie/5.-glossarii.md#kusochno-lokalnaya-approksimaciya) функции.
