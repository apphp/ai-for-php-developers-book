...
Алгоритм k-ближайших соседей ([k-Nearest Neighbors](../../vvedenie/5.-glossarii.md#k-nn-k-nearest-neighbors-k-blizhaishikh-sosedei), k-NN) – один из самых интуитивных и при этом фундаментальных алгоритмов машинного обучения. Он почти не делает предположений о данных, не обучает параметрическую модель, а хранит обучающие данные и опирается на простую, почти геометрическую идею: _похожие объекты должны иметь похожие ответы_.
...
В отличие от [линейной](../../vvedenie/5.-glossarii.md#lineinaya-regressiya) или [логистической](../../vvedenie/5.-glossarii.md#logisticheskaya-regressiya) регрессии, k-NN не пытается найти одну общую формулу для всех данных. У него нет коэффициентов, весов или оптимизируемой функции потерь в явном параметрическом виде.
...
[Евклидово расстояние](../../vvedenie/5.-glossarii.md#evklidovo-rasstoyanie) - самая распространённая метрика:
...
[Манхэттенское расстояние](../../vvedenie/5.-glossarii.md#mankhettenskoe-rasstoyanie) - это когда важнее не прямая линия, а сумма перемещений по осям:
...
Обобщающая форма для [расстояния Минковского](../../vvedenie/5.-glossarii.md#minkovskogo-rasstoyanie):
...
Когда важна не длина вектора, а направление. Формально это [косинусное сходство](../../vvedenie/5.-glossarii.md#cosine-similarity-kosinusnoe-skhodstvo), а не расстояние.
...
k-NN – наглядный пример классического компромисса [bias–variance](../../vvedenie/5.-glossarii.md#bias-variance-tradeoff).
...
* отбора признаков
* снижения размерности (например, при помощи [PCA](../../vvedenie/5.-glossarii.md#pca-principal-component-analysis-metod-glavnykh-komponent) или [autoencoders](../../vvedenie/5.-glossarii.md#autoencoders-avtoenkodery))
