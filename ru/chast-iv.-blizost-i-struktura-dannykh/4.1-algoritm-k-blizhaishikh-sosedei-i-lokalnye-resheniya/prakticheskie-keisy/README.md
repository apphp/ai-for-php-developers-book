...
* **Кейс 1. Классификация клиента по поведению**\
  &#xNAN;_&#x41F;онимаем_ k-NN _на простом поведенческом примере._
* **Кейс 2. Регрессия: оценка цены квартиры**\
  &#xNAN;_&#x41F;рименяем_ k-NN _для предсказания числового значения._
* **Кейс 3. Классификация с RubixML**\
  &#xNAN;_&#x41F;ереходим от ручной реализации к библиотеке._
