...
Далее мы рассмотрим следующие кейсы:

* **Кейс 1. Классификация клиента по поведению**\
  _&#x41F;онимаем_ k-NN _на простом поведенческом примере._
* **Кейс 2. Регрессия: оценка цены квартиры**\
  _&#x41F;рименяем_ k-NN _для предсказания числового значения._
* **Кейс 3. Классификация с RubixML**\
  _&#x41F;ереходим от ручной реализации к библиотеке._
