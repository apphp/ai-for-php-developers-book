...
Log loss – это не просто мера ошибки, а штраф за необоснованную уверенность.
...
Таким образом, в этом кейсе Model A: уверена и права, но получает меньший loss. Model B: менее уверена, хотя тоже права и платит за это более высоким loss.
