...
Используем стандартную бинарную [log loss](../../../vvedenie/glossarii.md#log-loss-logarifmicheskaya-funkciya-poter). Математически это будет реализация следующей формулы:
...
Так образом, в этом кейсе Model A: уверена и права, но получает меньший loss. Model B: менее уверена, хотя тоже права и платит за это более высоким loss.
