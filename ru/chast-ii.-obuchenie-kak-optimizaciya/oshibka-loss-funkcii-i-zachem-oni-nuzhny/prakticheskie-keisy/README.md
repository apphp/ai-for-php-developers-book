...
* **Кейс 1: MSE и цена большого промаха**\
  &#xNAN;_&#x41A;ак один выброс может доминировать над всей ошибкой модели._
* **Кейс 2: Выбор модели через loss-функцию**\
  &#xNAN;_&#x421;равнение нескольких моделей на одном наборе данных._
* **Кейс 3: Log loss и уверенность классификатора**\
  &#xNAN;_&#x41F;очему вероятность важнее бинарного ответа._
* **Кейс 4: Одинаковая точность – разный log loss**\
  &#xNAN;_&#x41A;огда accuracy вводит в заблуждение._
* **Кейс 5: Обучение модели как минимизация ошибки**\
  &#xNAN;_&#x41F;оиск параметров через уменьшение loss и минимизация loss на примере PHP-библиотеки._
