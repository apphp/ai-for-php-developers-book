...
С точки зрения геометрии, [MSE](../../vvedenie/glossarii.md#mse-mean-squared-error) – это средний квадрат расстояния между точками и предсказаниями.
...
Иначе говоря, MSE – это не просто удобная формула. Используя её, мы молчаливо предполагаем, что шум $$\varepsilon$$ подчиняется [нормальному распределению](../../vvedenie/glossarii.md#gaussovo-raspredelenie) – тому самому "колоколу Гаусса".
