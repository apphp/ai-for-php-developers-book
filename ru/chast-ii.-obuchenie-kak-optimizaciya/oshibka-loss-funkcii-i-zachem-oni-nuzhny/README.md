...
Но использовать такую ошибку напрямую неудобно. Она может быть отрицательной и положительной. Если у нас много объектов, ошибки начнут компенсировать друг друга.
...
С точки зрения геометрии, [MSE](../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#mse-mean-squared-error) – это средний квадрат расстояния между точками и предсказаниями.
...
Loss-функция – это язык, на котором мы разговариваем с моделью. Через неё мы объясняем, что считаем ошибкой, какие ошибки катастрофичны, а что допустимым компромиссом.
