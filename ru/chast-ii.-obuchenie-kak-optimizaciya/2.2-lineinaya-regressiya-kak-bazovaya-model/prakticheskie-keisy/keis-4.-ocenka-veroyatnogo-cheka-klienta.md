...
Для реализации используем Rubix ML и линейную регрессию с [L2-регуляризацией](../../../vvedenie/glossarii.md#l2-regulyarizaciya) (Ridge). Регуляризация здесь важна: поведенческие признаки часто коррелируют между собой, и Ridge помогает избежать раздутых весов.
