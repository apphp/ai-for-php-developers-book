...
Значение параметра $$w$$ – это положение по горизонтали. Значение ошибки $$L(w)$$ – это высота.
...
{% hint style="info" %}
[Градиент](../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#gradient) = это вектор частных производных функции по всем её переменным.
{% endhint %}
