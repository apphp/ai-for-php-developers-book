...
Название может звучать непонятно, но сама идея очень просто и интуитивна. В её основе лежит понятие производной: она показывает направление, в котором функция растёт быстрее всего. А значит, если мы хотим уменьшить значение функции ошибки, двигаться нужно в противоположную сторону – против [градиента](../../vvedenie/glossarii.md#gradient).
...
Здесь $$\eta$$ (эта буква называется "эта") – это скорость обучения, или [learning rate](../../vvedenie/glossarii.md#learning-rate-skorost-obucheniya).
...
Перед тем как перейди к реализации давайте повторим ещё раз:
