---
description: Наблюдаем, как значение параметра меняется и постепенно сходится к оптимуму.
---
...
Функция ошибки – среднеквадратичная ([MSE](../../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#mse-mean-squared-error)). Метод оптимизации – [batch gradient descent](../../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#batch-gradient-descent-bgd).
...
Поскольку $$y_i=2x_iy_i$$​, производная принимает вид:
