...
Используем стандартную бинарную [log loss](../../../vvedenie/glossarii.md#log-loss-logarifmicheskaya-funkciya-poter). Как вы помните из предыдущего кейса математически log loss определяется следующей формулой:
