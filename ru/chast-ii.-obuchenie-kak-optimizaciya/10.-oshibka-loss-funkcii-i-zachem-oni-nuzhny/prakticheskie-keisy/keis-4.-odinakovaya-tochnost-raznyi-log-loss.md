...
Используем стандартную бинарную [log loss](../../../vvedenie/5.-glossarii.md#log-loss-logarifmicheskaya-funkciya-poter). Как вы помните из предыдущего кейса математически log loss определяется следующей формулой:
