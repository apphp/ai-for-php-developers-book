...
Функция ошибки – среднеквадратичная ([MSE](../../../vvedenie/glossarii.md#mse-mean-squared-error)). Метод оптимизации – [batch gradient descent](../../../vvedenie/glossarii.md#batch-gradient-descent-bgd).
