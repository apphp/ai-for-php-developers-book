...
Функция ошибки – среднеквадратичная ([MSE](../../../vvedenie/5.-glossarii.md#mse-mean-squared-error)). Метод оптимизации – [batch gradient descent](../../../vvedenie/5.-glossarii.md#batch-gradient-descent-bgd).
