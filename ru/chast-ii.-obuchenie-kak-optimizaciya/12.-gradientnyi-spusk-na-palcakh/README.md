...
Этот механизм называется [градиентным спуском](../../vvedenie/5.-glossarii.md#gradientnyi-spusk).
...
Представим себе очень простую ситуацию. У нас есть модель с одним параметром $$w$$. Мы меняем $$w$$ и каждый раз считаем ошибку $$L(w)$$. Например, это может быть [MSE](../../vvedenie/5.-glossarii.md#mse-mean-squared-error).
...
* если производная равна нулю, то мы либо в минимуме, либо в максимуме, либо на плато (в многомерном случае – также в [седловой точке](../../vvedenie/5.-glossarii.md#sedlovaya-tochka))
...
Здесь $$\eta$$ (эта буква называется "_эта_") – это скорость обучения, или [learning rate](../../vvedenie/5.-glossarii.md#learning-rate-skorost-obucheniya).
...
{% hint style="info" %}
[Градиент](../../vvedenie/5.-glossarii.md#gradient) = это вектор частных производных функции по всем её переменным.
{% endhint %}
...
3. много раз (эпох – [epochs](../../vvedenie/5.-glossarii.md#epoch-epokha)) считает ошибку,
...
* упрощает [backprop](../../vvedenie/5.-glossarii.md#backpropagation-obratnoe-rasprostranenie-oshibki),
