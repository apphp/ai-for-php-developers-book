...
Мы будем использовать градиентный спуск, матрицу признаков $$X$$ размером $$N \times 4$$ и вектор весов $$w$$ длины 4. [Bias](../../../vvedenie/5.-glossarii.md#bias-smeshenie) добавим как дополнительный признак со значением 1.
