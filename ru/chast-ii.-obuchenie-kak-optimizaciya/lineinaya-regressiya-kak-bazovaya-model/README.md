...
Строго говоря, величина $$e$$ называется остатком (residual), а функция, которую мы  оптимизируем (чуть ниже мы о ней поговорим), называется [функцией потерь](../../vvedenie/glossarii.md#loss-funkciya).
