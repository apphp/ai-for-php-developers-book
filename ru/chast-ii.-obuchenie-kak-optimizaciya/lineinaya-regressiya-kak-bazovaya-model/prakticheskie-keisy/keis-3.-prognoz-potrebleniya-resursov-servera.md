...
Такое предсказание может использоваться напрямую в логике [auto-scaling](../../../vvedenie/glossarii.md#auto-scaling).
...
В DevOps-кейсе данные со временем меняются. Добавляются новые фичи, меняется профиль трафика, появляются кэши и оптимизации. Это классический пример [concept drift.](../../../vvedenie/glossarii.md#concept-drift)
