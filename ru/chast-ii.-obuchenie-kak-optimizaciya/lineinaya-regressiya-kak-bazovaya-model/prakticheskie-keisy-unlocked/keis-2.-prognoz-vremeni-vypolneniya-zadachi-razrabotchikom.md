---
description: >-
  Оценить срок выполнения новой задачи, находя наиболее похожие задачи из
  прошлых проектов.
---
...
{% hint style="warning" %}
Важно: story points здесь используются осознанно как числовая эвристика. Мы понимаем, что это относительная оценка сложности, а не физическая величина времени, и используем её как один из входных сигналов модели, а не как "истину".
{% endhint %}
...
// Результат: 
// Оценка времени выполнения: 5.33ч
```
