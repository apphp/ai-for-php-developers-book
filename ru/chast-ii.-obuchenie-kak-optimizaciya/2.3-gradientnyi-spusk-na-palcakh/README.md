...
Этот механизм называется [градиентным спуском](../../vvedenie/glossarii.md#gradientnyi-spusk).
...
Представим себе очень простую ситуацию. У нас есть модель с одним параметром $$w$$. Мы меняем $$w$$ и каждый раз считаем ошибку $$L(w)$$. Например, это может быть [MSE](../../vvedenie/glossarii.md#mse-mean-squared-error).
...
* если производная равна нулю, то мы либо в минимуме, либо в максимуме, либо на плато (в многомерном случае – также в [седловой точке](../../vvedenie/glossarii.md#sedlovaya-tochka))
...
Здесь $$\eta$$ (эта буква называется "_эта_") – это скорость обучения, или [learning rate](../../vvedenie/glossarii.md#learning-rate-skorost-obucheniya).
...
{% hint style="info" %}
[Градиент](../../vvedenie/glossarii.md#gradient) = это вектор частных производных функции по всем её переменным.
{% endhint %}
...
3. много раз (эпох – [epochs](../../vvedenie/glossarii.md#epoch-epokha)) считает ошибку,
...
* упрощает [backprop](../../vvedenie/glossarii.md#backpropagation-obratnoe-rasprostranenie-oshibki),
