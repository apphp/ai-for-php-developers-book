...
## 6. Простая агентная система на PHP
...
## 10. Планирование нескольких шагов
...
## 14. Практический кейс: AI-аналитик логов

<br>

Агент может анализировать security-логи.

<br>

Шаги:

1. Найти подозрительные строки
2. Посчитать частоту IP
3. Выделить аномалии
...
Это напрямую связано с security awareness, о котором вы пишете книгу и используете в вашей B2B-платформе симуляции фишинга.

<br>

LLM становится аналитическим агентом безопасности.

***

## 15. Почему агентные системы – это будущее LLM
...
Если хочешь, я могу ещё сделать следующую очень полезную главу для книги:

<br>

“ReAct, Plan-and-Execute и Toolformer – реальные паттерны агентных систем”

<br>

Она идеально продолжает эту главу и сильно усиливает архитектурную часть книги.
