...
* $$X=(x_1​,...,x_n​)$$ – все признаки (пиксели)
* $$P(C)$$ – априорная вероятность класса
...
Вот это и есть формула наивного Байеса.
...
> совместная вероятность $$P(x1​,...,xn​∣C)$$ заменяется на произведение независимых вероятностей признаков
...
Это очень важно: несмотря на вероятностную природу, граница решений у наивного Байеса часто линейная после лог-преобразования вероятностей. То есть наивный Байес – это сумма "доказательств" за класс.
