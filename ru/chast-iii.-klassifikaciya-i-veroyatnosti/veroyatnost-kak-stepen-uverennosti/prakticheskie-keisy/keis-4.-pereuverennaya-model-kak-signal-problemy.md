...
#### Расширенная проверка (на уровне батча)
...
\[IMAGE PLACEHOLDER: нормальное распределение вероятностей vs переуверенное]

<br>

Промпт для картинки:

“Two histograms side by side: left shows well-calibrated probabilities spread between 0 and 1, right shows overconfident model with most values near 0 and 1, clean ML educational diagram”
