...
Ключевая идея: вероятность – это "живое знание", которое эволюционирует со временем.
...
Мы обновили уверенность, а не пересчитали её "с нуля".
...
Этот пример – упрощенная версия байесовского обновления.
...
Разница в том, что здесь используется простая линейная модель, а не формула Байеса. Но интуиция та же:&#x20;
...
Но даже в сложных моделях сохраняется та же идея:&#x20;

> вероятность обновляется при поступлении новых данных.

#### Визуальная интуиция

<div align="left"><figure><img src="../../../.gitbook/assets/13.5-increase-in-prob-over-time.png" alt="" width="563"><figcaption><p>13.5 Рост вероятности со временем при поступлении сигналов</p></figcaption></figure></div>
