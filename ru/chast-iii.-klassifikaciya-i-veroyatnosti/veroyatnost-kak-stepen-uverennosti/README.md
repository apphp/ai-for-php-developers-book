...
Начнем с привычного. Если мы много раз подбрасываем честную монетку (такую, у которой ни одна сторона не выпадает чаще другой в долгой серии бросков), то ожидаем, что орел будет выпадать примерно в половине случаев. Формально это записывается так:
