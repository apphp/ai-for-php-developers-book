...
Это обычное [аффинное преобразование](../../vvedenie/5.-glossarii.md#affinnoe-preobrazovanie): скалярное произведение вектора признаков и весов плюс смещение. В линейной регрессии $$z$$ и было бы итоговым предсказанием. В логистической регрессии $$z$$ – лишь промежуточная величина, которая интерпретируется как логарифм шансов ([log-odds](../../vvedenie/5.-glossarii.md#log-odds)) и сама по себе не является вероятностью.

Чтобы превратить [логит](../../vvedenie/5.-glossarii.md#logits) в вероятность, используется сигмоидная (логистическая) функция:
