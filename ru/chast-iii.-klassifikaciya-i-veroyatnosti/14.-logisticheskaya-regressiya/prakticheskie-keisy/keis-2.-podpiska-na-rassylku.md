...
В данном запуске модель размещает [decision boundary](../../../vvedenie/5.-glossarii.md#decision-boundary-granica-prinyatiya-resheniya) примерно в районе 3 минут (конкретное значение зависит от обученных параметров и регуляризации).
