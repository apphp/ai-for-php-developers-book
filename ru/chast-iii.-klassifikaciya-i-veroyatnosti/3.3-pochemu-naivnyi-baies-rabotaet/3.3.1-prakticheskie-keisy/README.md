...
Кейсы выстроены от простого к более реалистичному. Сначала – минимальная классификация на категориальных признаках, где особенно хорошо видно предположение о независимости. Затем – классический спам-фильтр, в котором каждый признак вносит свой вклад ("голос") в итоговую вероятность класса. И наконец – числовые признаки и [гауссово распределение](../../../vvedenie/glossarii.md#gaussovo-raspredelenie), чтобы показать, что наивный Байес не ограничивается только текстами.
...
* **Кейс 1. Категориальные признаки и частоты**\
  _&#x41F;онимаем механику Байеса через частоты._
* **Кейс 2. Спам-фильтр на словах (Bernoulli Naive Bayes)**\
  _&#x41F;рименяем Байеса к реальной задаче классификации текста._
* **Кейс 3. Числовые признаки (Gaussian Naive Bayes)**\
  _&#x420;асширяем Байеса на числовые признаки._
