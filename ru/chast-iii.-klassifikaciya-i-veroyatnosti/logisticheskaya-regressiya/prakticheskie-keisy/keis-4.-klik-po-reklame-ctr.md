...
$$
z = w_1 \cdot hour + w_2 \cdot device + b
$$
...
Если вероятность выше выбранного порога, система может, например:
...
В реальной системе на основе такой модели можно:
