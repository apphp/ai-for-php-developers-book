---
description: Предсказание регистрации на email-рассылку (1 признак).
---
...
* "yes" – пользователь подписался
* "no" – пользователь не подписался
...
В данном запуске модель размещает [decision boundary](../../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#decision-boundary-granica-prinyatiya-resheniya) примерно в районе 3 минут (конкретное значение зависит от обученных параметров и регуляризации).
...
При стандартном пороге 0.5 это эквивалентно условию: $$w_1  x + b = 0$$

В одномерном случае это не линия, а одна точка на оси.

#### Визуализация

<div align="left"><figure><img src="../../../.gitbook/assets/14.7-newsletter-sigmoid-1d.png" alt="" width="563"><figcaption><p>14.7 График сигмоиды для подписки на рассылку</p></figcaption></figure></div>
