---
description: Прогноз ухода клиента из сервиса.
---
...
Обучение происходит с помощью градиентного спуска по log loss. Внутри цикла нет ничего неожиданного: считаем предсказание, ошибку и двигаем веса в сторону уменьшения ошибки. Здесь мы реализуем стохастическую версию градиентного спуска (градиент считается по одному объекту $$x_i$$, а веса обновляем сразу после каждого примера​).
...
<div align="left"><figure><img src="../../../.gitbook/assets/14.6-churn-decision-boundary.png" alt="" width="563"><figcaption><p>14.6 Граница принятия решения об оттоке</p></figcaption></figure></div>
