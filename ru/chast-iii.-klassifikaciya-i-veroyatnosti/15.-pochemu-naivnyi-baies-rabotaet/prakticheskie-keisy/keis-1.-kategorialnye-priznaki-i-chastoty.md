---
description: Понимаем механику Байеса через частоты.
---
...
* строгое сглаживание вероятностей (например, [Laplace smoothing](../../../vvedenie/5.-glossarii.md#laplace-smoothing-sglazhivanie-laplasa))
