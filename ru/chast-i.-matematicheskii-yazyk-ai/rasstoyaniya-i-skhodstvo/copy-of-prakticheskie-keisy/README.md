...
🔒 **Полный доступ к практическим кейсам доступен в PRO версии книги**

{% hint style="success" %}
В **PRO версии** вы получите:

* **Кейс 2: Оценка релевантности объекта&#x20;**_**(использование скалярного произведения)**_
* **Кейс 3: Сравнение текстов&#x20;**_**(использование косинусного сходства)**_
...
Эти кейсы показывают, как применять методы машинного обучения в реальных задачах PHP-разработчика.
{% endhint %}
