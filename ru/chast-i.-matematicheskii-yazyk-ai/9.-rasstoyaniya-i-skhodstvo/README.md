...
В этой главе мы разберем три ключевых инструмента: [евклидово расстояние](../../vvedenie/5.-glossarii.md#evklidovo-rasstoyanie), [скалярное произведение](../../vvedenie/5.-glossarii.md#dot-product-skalyarnoe-proizvedenie) (dot product) и [косинусное сходство](../../vvedenie/5.-glossarii.md#cosine-similarity-kosinusnoe-skhodstvo) (cosine similarity). Они лежат в основе [k-NN](../../vvedenie/5.-glossarii.md#k-nn-k-nearest-neighbors-k-blizhaishikh-sosedei), линейных моделей, рекомендательных систем, поиска по текстам и [эмбеддингов](../../vvedenie/5.-glossarii.md#embeddings-embeddingi).
...
В машинном обучении это используется осознанно. В линейных моделях большое скалярное произведение означает сильную активацию. В нейросетях и [attention-механизмах](../../vvedenie/5.-glossarii.md#attention-mekhanizm) он интерпретируется как мера важности или связи.
...
* 0 – [ортогональные векторы](../../vvedenie/5.-glossarii.md#ortogonalnye-vektory)
...
Это делает косинусное сходство идеальной мерой для текстов и [эмбеддингов](../../vvedenie/5.-glossarii.md#embeddings-embeddingi), где длина вектора часто отражает не смысл, а масштаб (длина текста, частота слов).
