...
Формально пространство признаков обычно обозначают как $$R^n$$. Это означает, что каждый объект описывается вектором из $$n$$ вещественных чисел, а все такие векторы образуют единое абстрактное пространство. В нём определены операции сложения векторов и умножения на число, что позволяет применить к нему инструменты линейной алгебры. В практическом машинном обучении нам не так важны формальные аксиомы, но важно понимать, что модель всегда работает внутри фиксированного $$n$$-мерного пространства, заданного структурой признаков.\
\
