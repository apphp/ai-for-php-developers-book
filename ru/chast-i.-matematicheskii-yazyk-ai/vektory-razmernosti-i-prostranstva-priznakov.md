...
Хорошей визуализацией для PHP-разработчика может быть такое: пространство признаков – это то, где живут ваши данные после этапа [feature engineering](../vvedenie/glossarii.md#feature-engineering). До этого у вас были строки, даты, категории и JSON. После – только числа.
