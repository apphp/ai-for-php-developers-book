...
Именно поэтому [косинусное сходство](../vvedenie/zaklyuchitelnye-materialy/glossarii.md#cosine-similarity-kosinusnoe-skhodstvo) часто используется при работе с текстовыми  эмбеддингами и другими высокоразмерными данными, где направление вектора важнее его длины.
...
С формальной точки зрения всё это выражается через скалярное произведение. Скалярное произведение двух векторов $$\mathbf{x}$$ и $$\mathbf{y}$$ определяется как:
...
<div align="left"><figure><img src="../.gitbook/assets/6.3.-knn-in-feature-space.png" alt="" width="563"><figcaption><p>8.3 Алгоритм k-NN в пространстве признаков</p></figcaption></figure></div>
