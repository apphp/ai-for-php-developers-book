...
Те алгоритмы машинного обучения, с которым мы сталкивались раньше, принимают на вход вектор чисел:
...
Формулы не усложняются из-за роста размерности. Однако интерпретация расстояний и поведение данных при этом заметно меняются. Они просто суммируют больше слагаемых.
