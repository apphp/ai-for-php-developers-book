...
Геометрически это две точки в пятимерном пространстве. Они очень близки: отличаются только по координатам, соответствующим одному слову.
...
На первый взгляд подход "слово = признак" кажется грубым. Он игнорирует порядок слов, грамматику, иронию, сарказм и вообще половину того, что мы считаем смыслом.
