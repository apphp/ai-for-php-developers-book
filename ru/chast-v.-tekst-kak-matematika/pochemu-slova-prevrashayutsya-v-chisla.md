...
Модель может начать использовать числовые закономерности, которые для нас не имеют смысловой интерпретации. Иными словами - видеть закономерности там, где их не существует.
