...
* **Кейс 1. Внутренний корпоративный ассистент по регламентам и политикам**\
  _&#x41A;ак превратить корпоративную базу знаний в диалоговый интерфейс._
...
* **Кейс 3. Семантический поиск по базе тикетов поддержки**\
  _&#x41A;ак находить решения проблем по смыслу, а не по ключевым словам._

Кейс 4: LLPhant

* **Кейс 4. RAG для внутренней документации с использованием LLPhant**\
  _&#x41E;т ручной реализации к специализированным инструментам PHP._
