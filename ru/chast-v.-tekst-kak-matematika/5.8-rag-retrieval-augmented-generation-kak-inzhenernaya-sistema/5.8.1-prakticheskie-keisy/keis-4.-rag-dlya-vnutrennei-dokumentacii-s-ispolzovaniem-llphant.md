...
LLPhant закрывает инфраструктурную часть ([эмбеддинги](../../../vvedenie/glossarii.md#embeddings-embeddingi) + векторное хранилище), но не принимает архитектурных решений за нас.
