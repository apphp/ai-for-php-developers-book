...
Классический поиск по словам (типа: SQL LIKE, [TF-IDF](../../vvedenie/glossarii.md#tf-idf), [BM25](../../vvedenie/glossarii.md#bm25-best-matching-25)) ищет совпадения токенов. RAG же опирается на семантическую близость. При этом на практике многие production-системы используют гибридный поиск, объединяя BM25, векторный поиск и последующее ранжирование результатов.
...
подсчитаем для него меру косинусного сходства с имеющимися документами и отсортируем результат по увыванию:
