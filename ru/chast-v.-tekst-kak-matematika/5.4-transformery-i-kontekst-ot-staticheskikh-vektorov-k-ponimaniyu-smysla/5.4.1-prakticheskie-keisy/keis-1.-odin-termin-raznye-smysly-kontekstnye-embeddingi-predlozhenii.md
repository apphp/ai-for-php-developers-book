...
обычно оказывается ещё дальше от первых двух, поскольку здесь слово используется уже в переносном смысле.
...
> Контекст задаёт геометрию пространства. Слово "ключ" не имеет собственного смысла вне предложения.
