...
Это очень грубая оценка. Фактическое количество токенов зависит от используемого токенизатора, структуры текста, количества специальных символов и языка документа.
...
Поэтому бесконечный контекст невозможен даже на очень мощных GPU, так как увеличение контекстного окна требует всё больше памяти и вычислительных ресурсов, а это делает бесконечный контекст практически недостижимым.
