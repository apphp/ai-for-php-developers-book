...
Поэтому бесконечный контекст невозможен даже на очень мощных GPU, так как увеличение контекстного окна требует всё больше памяти и вычислительных ресурсов и это делает бесконечный контекст практически недостижимым.
...
function chunkWithOverlap(string $text, int $size = 1000, int $overlap = 200): array {
    ...
    for ($i = 0; $i < strlen($text); $i += ($size - $overlap)) {
