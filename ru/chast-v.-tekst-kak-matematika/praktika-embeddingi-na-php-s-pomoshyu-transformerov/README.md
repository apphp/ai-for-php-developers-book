...
Формально [эмбеддинг](../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#embeddings-embeddingi) – это отображение из пространства текстов в евклидово пространство фиксированной размерности:
...
<div align="left"><figure><img src="../../.gitbook/assets/23.1-cosine-similarity-vectors.png" alt=""><figcaption><p>23.1 Векторы косинусного сходства</p></figcaption></figure></div>
