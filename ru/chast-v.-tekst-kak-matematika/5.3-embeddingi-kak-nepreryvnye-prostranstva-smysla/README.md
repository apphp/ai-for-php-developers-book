...
Ключевая идея эмбеддингов звучит почти философски: смысл – это не правило, а положение. Модель больше не проверяет набор условий – она измеряет взаимное расположение объектов.
