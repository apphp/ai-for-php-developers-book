...
Важно понимать: embeddings не хранят знания в виде явных символических фактов или правил. Вместо этого они кодируют статистические отношения между объектами (хранят геометрию отношений).
...
Хотя качество такого поиска сильно зависит от модели, домена и качества embeddings.
...
Здесь embeddings становятся универсальным представлением, через которое разные типы данных можно сравнивать геометрически.
