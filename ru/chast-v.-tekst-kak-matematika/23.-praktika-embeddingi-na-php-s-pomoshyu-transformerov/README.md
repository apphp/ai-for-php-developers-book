...
Формально [эмбеддинг](../../vvedenie/5.-glossarii.md#embeddings-embeddingi) – это отображение из пространства текстов в евклидово пространство фиксированной размерности:
