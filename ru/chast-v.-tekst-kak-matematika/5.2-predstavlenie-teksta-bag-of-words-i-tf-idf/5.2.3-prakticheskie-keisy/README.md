...
* **Кейс 1. Поиск похожих документов (чистый PHP)**\
  &#xNAN;_&#x421;равнение текстов через TF–IDF и cosine similarity для поиска близких по смыслу документов._
* **Кейс 2. Классификация отзывов: "положительный / отрицательный" (RubixML)**\
  &#xNAN;_&#x410;втоматическое определение тональности текста с помощью Bag of Words и TF–IDF._
* **Кейс 3. Автоматическая категоризация статей (RubixML)**\
  &#xNAN;_&#x420;аспределение текстов по темам на основе ключевых слов и статистических весов._
* **Кейс 4. Детектор "спама" в формах обратной связи (чистый PHP)**\
  &#xNAN;_&#x412;ыявление спам-сообщений по характерным словам и текстовым паттернам._
* **Кейс 5. Объяснимый поиск: "почему найден именно этот документ?" (чистый PHP)**\
  &#xNAN;_&#x420;азбор вклада слов и TF–IDF-весов для интерпретации результатов поиска._
* **Кейс 6. Сравнение Bag of Words и TF–IDF на одном примере**\
  &#xNAN;_&#x41D;аглядное сопоставление двух подходов и анализ различий в итоговых признаках и результатах._
