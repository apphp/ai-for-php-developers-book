...
Классический поиск по словам (LIKE, [TF-IDF](../../vvedenie/zaklyuchitelnye-materialy/glossarii.md#tf-idf), BM25) ищет совпадения токенов. RAG же опирается на семантическую близость.
