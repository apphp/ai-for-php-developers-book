...
Без линейной алгебры невозможно по-настоящему понять эмбеддинги, [матричную факторизацию](../vvedenie/zaklyuchitelnye-materialy/glossarii.md#matrichnaya-faktorizaciya) и нейронные сети.
...
Это стандартная функция потерь бинарной классификации (binary [cross-entropy](../vvedenie/zaklyuchitelnye-materialy/glossarii.md#cross-entropy-kross-entropiya)), которая используется в логистической регрессии и нейронных сетях. Понимание того, как эта функция оптимизируется и почему градиентный спуск находит хороший минимум, дает уверенность, что модель обучается стабильно.
...
<div align="left"><figure><img src="../.gitbook/assets/35.1-map-of-development-directions.png" alt="" width="563"><figcaption><p>35.1 Карта направлений развития</p></figcaption></figure></div>
