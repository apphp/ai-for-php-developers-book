...
Несмотря на успешное обучение, модель лишь изменила положение своей разделяющей гиперплоскости. Она не стала "умнее" в математическом смысле – её возможности по-прежнему ограничены линейной границей. Если задача требует нелинейного разделения, никакое количество эпох обучения уже не поможет.

Чтобы научить её решать более сложные нелинейные задачи, необходимо объединить несколько нейронов в слои. Но прежде нужно понять, почему простого добавления новых линейных слоев недостаточно.
