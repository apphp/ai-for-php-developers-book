...
Тут может возникнуть закономерный вопрос: насколько мощной может быть такая архитектура? Ответ на это дает одна из самых известных теорем теории нейронных сетей.
