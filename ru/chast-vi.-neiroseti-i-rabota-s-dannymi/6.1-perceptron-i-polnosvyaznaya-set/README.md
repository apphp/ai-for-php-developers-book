...
Именно эта формула станет одной из самых важных во всей книге. В разных моделях будут меняться функции активации, способы обучения и архитектура сети, но вычисление линейной комбинации останется практически неизменным.
...
Возникает естественный вопрос: а что произойдет, если одной прямой уже недостаточно? Именно этот вопрос определяет главное ограничение перцептрона, которое мы рассмотрим далее.
...
Возникает естественный вопрос: можно ли объединить несколько перцептронов таким образом, чтобы вместе они смогли описывать более сложные границы? В конечном счёте, именно поиск ответа на этот вопрос и привел к созданию многослойных нейронных сетей.

Но прежде чем двигаться дальше, желательно реализовать классический перцептрон самостоятельно. Благодаря этому станет понятно, насколько проста его внутренняя логика и почему одной такой модели оказывается недостаточно.
...
Возникает закономерный вопрос: насколько мощной может быть такая архитектура? Ответ на это дает одна из самых известных теорем теории нейронных сетей.
