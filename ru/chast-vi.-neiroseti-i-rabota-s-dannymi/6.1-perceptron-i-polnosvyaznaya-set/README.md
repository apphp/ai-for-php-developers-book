...
С каждым проходом по данным граница постепенно "подстраивается". Однако само обучение не меняет природу модели. Как бы долго ни обучался перцептрон, он по-прежнему остается линейным классификатором.
...
Теперь остается разобраться, какие функции активации используются на практике и почему именно они стали стандартом.
