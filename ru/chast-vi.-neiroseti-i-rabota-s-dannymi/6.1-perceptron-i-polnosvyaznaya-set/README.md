...
Несмотря на то что современные архитектуры выглядят невероятно сложными, в их основе  лежит один и тот же принцип: вычисление взвешенной суммы входов с последующим применением функции активации. Классический перцептрон использовал пороговую функцию, тогда как современные нейронные сети используют более сложные функции, о которых мы поговорим позже в этой главе.
