...
<figure><img src="../../.gitbook/assets/6.3-1_convolution-kernel-sliding.png" alt=""><figcaption><p>Рис. 6.3-1. Скольжение свёрточного ядра по изображению</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/6.3-2_deep-learning-cnn-hierarchy.png" alt=""><figcaption><p>Рис. 6.3-2. Иерархия обучения в сверточных нейросетях</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/6.3-3_max-pooling-on-feature-map.png" alt=""><figcaption><p>Рис. 6.3-3. Операция максимального пулинга на карте объектов</p></figcaption></figure>
...
PHP не используется для глубокого обучения в продакшене, но для понимания – отлично.
