...
## Когда AI не нужен и почему это важно. Понятные инженерные границы
...
### Иллюстрация: рост сложности системы

\[PLACEHOLDER\_IMAGE\_2]

Промпт:

> Diagram showing two stacks. Left stack: “Simple deterministic system” with 3 blocks (Code, Database, Server). Right stack: “AI system” with many blocks (Code, Database, Model, Vector DB, Embeddings, GPU, API, Monitoring). Technical, clean white background.

***

***

### 11. Финансовая функция сложности
...
Cost\_{AI} = C\_{integration} + C\_{inference} + C\_{monitoring}
...
### 12. Чек-лист: действительно ли нужен AI?
...
### 13. Где AI действительно оправдан
...
Если хотите, могу добавить к этой главе практический кейс “Как мы заменили LLM на 40 строк PHP и снизили cost в 15 раз” – с цифрами, кодом и сравнением latency.
